...
+ (const char *)getDBPath {
    NSURL *urlDirectory;
#ifndef TARGET_OS_TV
    urlDirectory = [[NSFileManager defaultManager] URLsForDirectory:NSLibraryDirectory inDomains:NSUserDomainMask][0];
#else
    urlDirectory = [NSURL fileURLWithPath: NSTemporaryDirectory()];
#endif
